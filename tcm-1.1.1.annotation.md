...
According to the internalists, for <span class="annotation refn" data-v="sec 5/detected">detecting</span> that an observation is evidential, it is necessary and sufficient that
...
Option 3 seperates type A internalism from B and C. <span class="annotation refn" data-v="sec 5/option 4">Option 4</span> seperates Type B from C.
...
<span class="annotation refn" data-v="sec 5/option 3">Option 3</span> seperates Type A internalism from B and C. Option 4 seperates Type B from C.
